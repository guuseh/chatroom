...
const Error = () => {
  ...
  return (
    <div style={{display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", height: "80vh", gap: "50px"}}>
      <div onClick={() => navigate('/works')} style={{position: "absolute", top: "var(--margin)", right: "var(--margin)", cursor: 'var(--pointer)', height: "70px"}}>
        <img src="/img/front/404.png" style={{height: "100%"}}/>
      </div>
